                ...
                if len(sys.argv) == 3:
                    ...
                    while i < len(peers):
                        try:
                            ...
                            if reply[4] > 0:
                                ratelateblocks = (
                                    ratelateblocks + float(reply[7]) / reply[4]
                                )
                                listratelateblocks = listratelateblocks + [
                                    float(reply[7]) / reply[4]
                                ]
                            ...
                            mainchainProducedBlock = mainchainProducedBlock + int(
                                reply[10]
                            )
                            listmainchainProducedBlock = listmainchainProducedBlock + [
                                int(reply[10])
                            ]
                            allblockswithconfirmed = allblockswithconfirmed + int(
                                reply[11]
                            )
                            listallblockwithconfirmed = listallblockwithconfirmed + [
                                int(reply[11])
                            ]
                            print(
                                "produced block in main chain by node %s: %d"
                                % (peers[i], int(reply[10]))
                            )
                            print(
                                "all produced block with a confirmed block: %d"
                                % (reply[11])
                            )
                        except Exception as e:
                            print(str(e))
                    ...
                    #########sync calls###############
                    print(
                        "sync function calls number in the network view: %d" % callsync
                    )
                    if callsync > 0:
                    ...
                    print(
                        "Reversed blocks number in the network view: %d \n"
                        % numrevblock
                    )
                    if numrevblock > 0:
                    ...
                    if avgconf > 0:
                        ...
                        print(
                            "latency confirmation average in the network view (round): %f \n"
                            % avg
                        )
                    ...
                    print(
                        "all block produced with the same id that a confirmed block: %d\n"
                        % allblockswithconfirmed
                    )
                    if allblockswithconfirmed > 0:
                        avg = allblockswithconfirmed / float(
                            len(listallblockwithconfirmed)
                        )
                        variance = statistics.pvariance(listallblockwithconfirmed, avg)
                        print(
                            "average of the all block produced with the same id that a confirmed block: ",
                            avg,
                        )
                        print(
                            "variance of the all block produced with the same id that a confirme block: ",
                            variance,
                        )
                    print("\n")
                    ...
                    if mainchainProducedBlock > 0:
                        avg = mainchainProducedBlock / float(
                            len(listmainchainProducedBlock)
                        )
                    ...
                    if callsyncrev > 0:
                        print(
                            "Reversed blocks number average (Reversed blocks number / revertion): %f \n"
